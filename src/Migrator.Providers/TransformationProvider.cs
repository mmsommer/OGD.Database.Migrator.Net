...
namespace Migrator.Providers
{
    ...
    public abstract class TransformationProvider : ITransformationProvider
    {
        ...
        public virtual int Delete(string table, string[] columns, string[] values)
        {
            ...
            {
                return ExecuteNonQuery(String.Format("DELETE FROM {0} WHERE ({1})", table, JoinColumnsAndValues(" AND ", columns, values)));
            }
        }
        ...
        public string JoinColumnsAndValues(string seperator, string[] columns, string[] values)
        {
